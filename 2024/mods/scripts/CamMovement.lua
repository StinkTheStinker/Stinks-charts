...
--
local Intensity = 24; --[[      CHANGE YOUR INTENSITY CAMERA MOVEMENT HERE       ]]
-- default : 20
...
function onCreatePost()
    ...
    setPropertyFromClass('ClientPrefs', 'cameraPanning', false)
...
function onDestroy()
  setPropertyFromClass('ClientPrefs', 'cameraPanning', true)
end
